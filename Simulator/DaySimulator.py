...
class DaySimulator:
    ...
    @staticmethod
    def dayEnd(persons, thresholds_df, num_of_day, trace_days, quarantine_days, preferences_df, beginmodel, tracing_starts_on_day, output_dirname):
        # fline = open("seed.txt").readline().rstrip()
        # ranseed = int(fline)
        # np.random.seed(ranseed)
                ...
                if(prsn_state == 'Dead'):
                    ...
                    #     prsn.setState('contagious_symptomatic')
                        ...
                        if(prsn.is_traceable):
                            TRACING_STARTS_ON_DAY = tracing_starts_on_day
                            if(num_of_day>=TRACING_STARTS_ON_DAY):
                                ...
                                for numday in range(trace_start,rangeday):
                                    ...
                                    if numday<beginmodel:
                                        which_dir = ''
                                    else:
                                        which_dir = output_dirname

                                    filename = which_dir + 'group_info_day_' + str(numday) + '.p'                    
        ...
        #print('Day ends at '+ str(datetime.now()) + '\n')                    
